...
截至 2026-09-21，全系统共收录 **130 个唯一外部来源**（唯一编号以 HTML 附录 001–130 为准；README 附录 a01–a37 是 001–086 中 37 条的子集视图，各批扫描文档另保留批次编号 a/b/E）：
...
| **合计** | **130** | 001–130 | 001–086 归属复盘见 `33-appendix-full-review-20260920.md`；087–124 见 `34-web-scan-20260920.md` §八；125–130 见 `35-wechat-loop-engineering-20260921.md` §五 |

验证命令：`grep -oE '<tr><td>[0-9]{3}</td>' aiworflow-full-flow.html | wc -l` → 130（与 HTML 附录计数一致；逐条归属判定 docs/33 + docs/34 + docs/35）
